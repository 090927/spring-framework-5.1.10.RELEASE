...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public ConfigurableEnvironment getEnvironment() {
		if (this.environment == null) {
			...
			/**
			 *  environment 属性初始化。{@link #createEnvironment()}
			 */
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				 ...
				 *
				 * 调用所有注册的 BeanFactoryPostProcessor Bean {@link #invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory)}
				 *
				 */
				 ...
				 * 真正的调用在getBean时候
				 *  并将它们注册到容器Bean后处理器的注册表中，这里只是注册， {@link PostProcessorRegistrationDelegate#registerBeanPostProcessors(ConfigurableListableBeanFactory, AbstractApplicationContext)}
				 */
	...
	protected ConfigurableListableBeanFactory obtainFreshBeanFactory() {
		/**
		 * 1、父类定义抽象的 {@link #refreshBeanFactory() } 方法。
		 *
	...
	protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
		...
		/**
		 * 调用所有注册的 BeanFactoryPostProcessor Bean {@link PostProcessorRegistrationDelegate#invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory, List)}
		 */
	...
	protected void destroyBeans() {
		...
		/**
		 *  销毁bean【 destroySingletons 】{@link DefaultSingletonBeanRegistry#destroySingletons()}
		 */
