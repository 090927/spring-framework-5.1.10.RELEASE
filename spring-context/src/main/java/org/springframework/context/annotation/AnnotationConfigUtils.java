...
public abstract class AnnotationConfigUtils {
	...
	public static Set<BeanDefinitionHolder> registerAnnotationConfigProcessors(
		...
		/**
		 * 创建 IOC 容器 {@link #unwrapDefaultListableBeanFactory(BeanDefinitionRegistry)}
		 */
		...
		if (!registry.containsBeanDefinition(CONFIGURATION_ANNOTATION_PROCESSOR_BEAN_NAME)) {
			...
			/**
			 * 注册 IOC 容器 {@link DefaultListableBeanFactory#registerBeanDefinition(String, BeanDefinition)}
			 */
		...
		if (!registry.containsBeanDefinition(EVENT_LISTENER_PROCESSOR_BEAN_NAME)) {
			...
			/**
			 * EventListenerMethodProcessor 是 @EventListener 方法的生命周期处理器，
			 * 而DefaultEventListenerFactory 则是 @EventListener 方法与 ApplicationListener 适配器的工程类。
			 */
